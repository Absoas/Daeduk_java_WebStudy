...
/*   background-image: url("../images/travel3.jpg"); */
...
<section class="container">
		    <article class="half">
			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="#" method="post" enctype="multipart/form-data">
						                    ...
						                    <input type="text" name="reg" id="reg" class="inpt" required="required" placeholder="주민등록번호">
						                    <input type="text" name="id" id="id" class="inpt" required="required" placeholder="아이디">
						                    <input type="text" name="password" id="password" class="inpt" required="required" placeholder="비밀번호">
						                    <input type="email" name="email" id="email" class="inpt" required="required" placeholder="이메일">
						                    <input type="text" name="hp" id="hp" class="inpt" required="required" placeholder="핸드폰번호">
						                    <input type="text" name="home" id="home" class="inpt" required="required" placeholder="주소">
        					        </form>
                ...
                <form action="#" method="post" enctype="multipart/form-data">
						                    <input type="text"  class="inpt" required="required" placeholder="아이디">
						                    <input type="text"  class="inpt" required="required" placeholder="비밀번호">
						                    <input type="text"  class="inpt" required="required" placeholder="기업명">
						                    <input type="text"  class="inpt" required="required" placeholder="이메일">
						                    <input type="email" class="inpt" required="required" placeholder="대표번호">
						                    <input type="text"  class="inpt" required="required" placeholder="주소">
        					        </form>
						                    <div class="submit-wrap">
							                        <input type="submit" value="Sign up" class="submit">
						                    </div>
